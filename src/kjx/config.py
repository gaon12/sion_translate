...
class DataConfig:
    ...
    # 글로서리(용어집) JSON 경로. 지정하면 kjx-translate/evaluate 가 이 파일을
    # 기본으로 불러와 지정한 용어를 정해진 대응어로 강제합니다. 빈 문자열이면 끔.
    glossary: str = ""
    tokenizer_model: str = "artifacts/tokenizer/kjx.model"
...
class TrainingConfig:
    # 학습 산출물(체크포인트/로그/exports) 위치. kjx-translate 와 kjx-augment 도
